    ...
    if (date("Y-m-d", $appdate1) >= $cur_date) {
        if ((date("Y-m-d", $appdate1) == $cur_date && date("H:i:s", $apptime1) > $cur_time) || date("Y-m-d", $appdate1) > $cur_date) {
            ...
            if (mysqli_num_rows($check_query) == 0) {
                ...
                $userStatus = 1;
                $doctorStatus = 1;
                $stmt->bind_param("issssssssssi", $pid, $fname, $lname, $gender, $email, $contact, $doctor, $docFees, $appdate, $apptime, $userStatus, $doctorStatus);
...
if (isset($_GET['cancel'])) {
    $stmt = $con->prepare("UPDATE appointmenttb SET userStatus='0' WHERE ID = ?");
...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> Smart Health Monitoring </h2></br>
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> Smart Health Monitoring  </a>
  ...
  <body style="padding-top:50px;">
   ...
   <div class="container-fluid" style="margin-top:50px;">
    ...
    <div class="list-group" id="list-tab" role="tablist">
        <a class="list-group-item list-group-item-action active" id="list-dash-list" data-toggle="list" href="#list-dash" role="tab" aria-controls="dashboard">Dashboard</a>
        ...
        <a class="list-group-item list-group-item-action" href="#app-hist" id="list-pat-list" role="tab" data-toggle="list" aria-controls="history">Appointment History</a>
        <a class="list-group-item list-group-item-action" href="#list-pres" id="list-pres-list" role="tab" data-toggle="list" aria-controls="prescriptions">Prescriptions</a>
        <a class="list-group-item list-group-item-action" href="symptoms.php" id="list-symptoms-list" role="tab" aria-controls="symptoms">Symptoms Checker</a>
    </div><br>
</div>
